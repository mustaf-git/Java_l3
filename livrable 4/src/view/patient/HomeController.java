...
public class HomeController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        AnchorPane root;
        root = FXMLLoader.load(getClass().getResource("/view/patient/"+view+".fxml"));
    ...
    @FXML
    private void handleShowPrestation(ActionEvent event) throws IOException {
        loadView("v_lister_prestation");
    }
